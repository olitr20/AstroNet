...
trainloader0 = DataLoader(torch.load('./Train0.t7'), batch_size=1, shuffle=False)
trainloader1 = DataLoader(torch.load('./Train1.t7'), batch_size=1, shuffle=False)
trainloader2 = DataLoader(torch.load('./Train2.t7'), batch_size=1, shuffle=False)
trainloader3 = DataLoader(torch.load('./Train3.t7'), batch_size=1, shuffle=False)
trainloader4 = DataLoader(torch.load('./Train4.t7'), batch_size=1, shuffle=False)
trainloader5 = DataLoader(torch.load('./Train5.t7'), batch_size=1, shuffle=False)
trainloader6 = DataLoader(torch.load('./Train6.t7'), batch_size=1, shuffle=False)
trainloader7 = DataLoader(torch.load('./Train7.t7'), batch_size=1, shuffle=False)
trainloader8 = DataLoader(torch.load('./Train8.t7'), batch_size=1, shuffle=False)
trainloader9 = DataLoader(torch.load('./Train9.t7'), batch_size=1, shuffle=False)
...
torch.save(Train_Dataset, './Data/Train_CIFAR10''.t7')
val_data = np.array(val)
val_data = torch.from_numpy(val_data)
val_label = np.array(val_lable)
val_label = torch.from_numpy(val_label)
Train_Dataset = TensorDataset(val_data, val_label)
torch.save(Train_Dataset, './Data/Val_CIFAR10''.t7')

trainloader = torch.utils.data.DataLoader(torch.load('./Data/Train_CIFAR10.t7'), batch_size=1, shuffle=False)
valloader = torch.utils.data.DataLoader(torch.load('./Data/Val_CIFAR10.t7'), batch_size=1, shuffle=False)
